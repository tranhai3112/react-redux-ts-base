...
export const DanhSachNguoiDung = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchUser>({ pageNumber: 1, pageSize: 10, reFetch: true })
    ...
    const columns = useCoCauUser({ pageNumber: searchParams.pageNumber, pageSize: searchParams.pageSize })
    return <AntdTable 
        loading={loading} 
