...
export const SuaCoCauToChuc = ({handlerClose, visible, folderId}: {handlerClose: () => void, visible: boolean, folderId: string}) => {
    ...
    const onFinish: FormProps["onFinish"] = (values) => {
        if (folderId) {
            ...
            dispatch(UpdateCoCauToChuc({ id: folderId, data: values }))
        } 
        // else {
    ...
    return (
        <AntdModal title="Sửa thư mục" handlerCancel={handleCancel} visible={visible} footer={null} 
